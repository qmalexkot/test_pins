...
module PS9_SPP
#(
  parameter C_SPP_PSPMC_TO_CORE_WIDTH = 10000,
  parameter C_SPP_PSPMC_FROM_CORE_WIDTH = 10000
)
(
  // SPP - ports from PS9 definition
  ...
  output [7:0] SCANCHNLSPAREOUTEXTCCI,
  ...
  // SPP - additional ports
   ...
   output [C_SPP_PSPMC_TO_CORE_WIDTH-1:0] PSPMCTOCORE,
   input  [C_SPP_PSPMC_FROM_CORE_WIDTH-1:0] PSPMCFROMCORE
