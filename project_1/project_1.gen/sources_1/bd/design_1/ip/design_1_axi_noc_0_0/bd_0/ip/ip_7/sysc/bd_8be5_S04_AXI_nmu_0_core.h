...
//
//**********************************************************************
#ifndef _bd_8be5_S04_AXI_nmu_0_core_h_
#define _bd_8be5_S04_AXI_nmu_0_core_h_

#include "NOCMasterUnitXtlm.h"
#include "properties.h"

class bd_8be5_S04_AXI_nmu_0_core : public NOCMasterUnitXtlm
{
public:
...
bd_8be5_S04_AXI_nmu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_8be5_S04_AXI_nmu_0_core() = default;
