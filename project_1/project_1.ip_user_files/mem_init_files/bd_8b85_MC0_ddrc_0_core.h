...
//
//**********************************************************************
#ifndef bd_8b85_MC0_ddrc_0_core_h_
#define bd_8b85_MC0_ddrc_0_core_h_

#include "NOCDdrMcXtlm.h"
#include "properties.h"

class bd_8b85_MC0_ddrc_0_core : public NOCDdrMcXtlm
{
public:
  bd_8b85_MC0_ddrc_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  : NOCDdrMcXtlm(nm, props)
  {
  }

  virtual ~bd_8b85_MC0_ddrc_0_core()
  {
  }
...
public:  // stub pin-to-pin RTL interface
  ...
  sc_core::sc_out<sc_bv<2> >ch0_ddr4_cke;
  sc_core::sc_out<sc_bv<2> >ch0_ddr4_ck_t;
  sc_core::sc_out<sc_bv<2> >ch0_ddr4_ck_c;
  sc_core::sc_out<sc_bv<2> >ch0_ddr4_cs_n;
  sc_core::sc_out<sc_bv<9> >ch0_ddr4_dm_dbi_n;
  sc_core::sc_out<sc_bv<72> >ch0_ddr4_dq;
  sc_core::sc_out<sc_bv<9> >ch0_ddr4_dqs_c;
  sc_core::sc_out<sc_bv<9> >ch0_ddr4_dqs_t;
  sc_core::sc_out<sc_bv<2> >ch0_ddr4_odt;
